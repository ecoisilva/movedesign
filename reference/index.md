...
- [`print(`*`<movedesign_input>`*`)`](https://ecoisilva.github.io/movedesign/reference/print.movedesign_input.md)
  :
...
- [`summary(`*`<movedesign_check>`*`)`](https://ecoisilva.github.io/movedesign/reference/summary.movedesign_check.md)
  :

  Summary method for `movedesign_check` objects

- [`summary(`*`<movedesign_input>`*`)`](https://ecoisilva.github.io/movedesign/reference/summary.movedesign_input.md)
  :
